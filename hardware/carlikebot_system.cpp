...
#include "f112th_sim_2401_delta/carlikebot_system.hpp"
...
hardware_interface::return_type f112th_sim_2401_delta ::CarlikeBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
PLUGINLIB_EXPORT_CLASS(
  f112th_sim_2401_delta::CarlikeBotSystemHardware, hardware_interface::SystemInterface)

...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("f112th_sim_2401_delta"),"description", "carlikebot.urdf.xacro"]
            ),
        ]
    )
    ...
    robot_controllers = PathJoinSubstitution(
        [
            FindPackageShare("f112th_sim_2401_delta"),"config","carlikebot_controllers.yaml",
        ]
    )
    rviz_config_file = PathJoinSubstitution(
        [
            FindPackageShare("f112th_sim_2401_delta"), "description", "carlikebot.rviz",
        ]
    )
